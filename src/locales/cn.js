...
const cn = {
  ...
  edgeNode: {
    ...
    address: '地址',
    affinity: '架构',
    edgeNexusIp: 'Edge Nexus IP地址',
    edgeNexusPort: 'Edge Nexus 端口',
    applcmIp: '应用LCM地址',
    k8sUrl: 'K8S URL',
    monitor: '监控'
  },
  system: {
    ...
    edgeNodes: {
      ...
      edgeNexusName: 'Edge Nexus 名称',
      edgeNexusPass: 'Edge Nexus 密码',
      upload: '* 上传',
  ...
  verify: {
    ...
    usernameTip: '用户名不能为空。',
    passwordTip: '密码不能为空。',
    edgeNexusIpTip: 'Edge nexus IP不能为空。',
    edgeNexusPortTip: 'Edge nexus port不能为空。',
    edgeNexusUsernameTip: 'Edge nexus user name不能为空。',
    edgeNexusPasswordTip: 'Edge nexus password不能为空。',
