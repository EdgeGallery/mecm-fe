...
const en = {
  ...
  edgeNode: {
    ...
    address: 'Address',
    affinity: 'Architecture',
    edgeNexusIp: 'Edge Nexus Ip',
    edgeNexusPort: 'Edge Nexus Port',
    applcmIp: 'App LCM Ip',
    k8sUrl: 'K8S URL',
    monitor: 'Monitor'
  },
  system: {
    ...
    edgeNodes: {
      ...
      edgeNexusName: 'Edge Nexus Name',
      edgeNexusPass: 'Edge Nexus Password',
      upload: '* Upload',
  ...
  verify: {
    ...
    edgeNexusIpTip: 'Edge nexus ip should not be empty',
    edgeNexusPortTip: 'Edge nexus port should not be empty',
    edgeNexusUsernameTip: 'Edge nexus user name should not be empty',
    edgeNexusPasswordTip: 'Edge nexus password should not be empty',
  ...
  tip: {
    ...
    typeApp: 'Please type host ip first!',
